import { TagSymbols, TagFunctionsToString } from "./const/tags";
...
function split(value: string, amount: number = 0): Array<string> {
...
export function removeComments(value: string, shouldTrim: boolean = true) : {text: string} {
...
export function scanForVariables(value: string, shouldTrim: boolean = true) : {text: string, variables: string[]} {
  let isFirstParse = true;
  
  const tag = { text: "", variables: [ // Private Variables
